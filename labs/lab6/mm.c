 ...
 ******************************************************************************
 *                                    mm.c                                    *
 *                    segmented AVL tree memory allocator                     *
...
static inline char *AVL_tree(int idx) {
...
// left, right = NULL
// height = 1
static inline void init_node(void *ptr, size_t size) {
...
static inline void refresh_height(void *node) {
  PUT(HEIGHT(node), 1 + MAX(GET_HEIGHT(GET_PTR(LEFT_CHILD(node))),
                            GET_HEIGHT(GET_PTR(RIGHT_CHILD(node)))));
}

// Left rotate AVL tree at given node
static inline void *L_rotate(void *ptr) {
...
static inline void *R_rotate(void *ptr) {
...
static inline void *LL_rotate(void *ptr) {
...
static inline void *RR_rotate(void *ptr) {
...
static inline void *balance(void *root) {
...
static inline int get_idx(size_t size) {
  int idx = 0;
...
static void *find_fit(size_t targetSize);
static void rec_find_fit(void *root, size_t targetSize, void **allocateBlock);
static void *place(void *ptr, size_t targetSize);
static void insert_node(void *ptr, size_t size);
static void *rec_insert_node(void *root, void *ptr);
static void delete_node(void *ptr);
static void *rec_delete_node(void *root, void *ptr);
 ...
 */
static void rec_find_fit(void *root, size_t query, void **blk_ptr) {
  if (root == NULL)
    return;
